...
var newLambdaTrace = function (request, context) {
    var trace = new entities_1.Trace(context.awsRequestId, context.functionName, 'AWS_LAMBDA');
 ...
 */
exports.wrapLambdaHandler = function (func) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    trace = tracer_1.tracer.startNewTrace(newLambdaTrace(request, context));
